 ...
 * 
 * <p>
 * By default, this will only allow applications that are known to respond to this intent correctly do so. The apps that are allowed to response can be set with
 * {@link #setTargetApplications(Collection)}. For example, set to {@link #TARGET_BARCODE_SCANNER_ONLY} to only target the Barcode Scanner app itself.
 * </p>
 * 
...
public class IntentIntegrator {
	...
	/**
	 * Initiates a scan only for a certain set of barcode types, given as strings corresponding to their names in ZXing's {@code BarcodeFormat} class like "UPC_A". You can supply constants like
	 ...
	 * </p>
	 * 
	 * @return null if the event handled here was not related to this class, or else an {@link IntentResult} containing the result of the scan. If the user cancelled scanning, the fields will be null.
	 */
