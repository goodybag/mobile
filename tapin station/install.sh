...
echo "install busybox" #there is weird ordering here, because some tablets don't have the copy command!
adb shell mkdir -p /system/xbin;
adb shell chmod 755 /data/gb/system/binaries/busybox;
adb shell /data/gb/system/binaries/busybox --install -s /system/xbin;
...
adb shell /system/xbin/busybox cp -R -f /data/gb/system/libs/openssl/* /data/local/lib/;
adb shell /system/xbin/busybox cp -f /data/gb/system/binaries/linker /data/local/bin/linker;
adb shell /system/xbin/busybox cp -f /data/gb/system/binaries/openssl /data/local/bin/openssl;
