 ...
 * Copyright (c) 2009-2011 by Goodybag, Inc. All Rights Reserved.
...
//@interface GoodybagObject : NSObject
//@end

@interface GoodybagObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GoodybagObject class]])
		{
			for (NSString *key in [[(GoodybagObject*)o modules] allKeys])
			{
