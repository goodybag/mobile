...
// in simulator we redefine to format for Goodybag Developer console
...
{\
	NSString * exceptionName = [@"org.goodybag." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.goodybag";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIGoodybagNativeItemNone = -1, 
	UIGoodybagNativeItemSpinner = -2,
	UIGoodybagNativeItemProgressBar = -3,
	
	UIGoodybagNativeItemSlider = -4,
	UIGoodybagNativeItemSwitch = -5,
	UIGoodybagNativeItemMultiButton = -6,
	UIGoodybagNativeItemSegmented = -7,
	
	UIGoodybagNativeItemTextView = -8,
	UIGoodybagNativeItemTextField = -9,
	UIGoodybagNativeItemSearchBar = -10,
	
	UIGoodybagNativeItemPicker = -11,
	UIGoodybagNativeItemDatePicker = -12,
	
	UIGoodybagNativeItemInfoLight = -13,
	UIGoodybagNativeItemInfoDark = -14,
	
	UIGoodybagNativeItemDisclosure = -15,
	
	UIGoodybagNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Goodybag instances of
