...
var require = {
	app: {
		analytics: true,
		copyright: "2012 by Nijiko Yonskai",
		deployType: "development",
		description: "not specified",
		guid: "ab5a4024-ce04-4aa4-8e78-c931005538e2",
		id: "com.goodybag",
		name: "Goodybag",
		names: {},
...
function defineCloud(o){function x(r,h,f){if(void 0===h)throw"Argument "+r+" was not provided!";if(typeof h!=f)throw"Argument "+r+" was an unexpected type! Expected: "+f+", Received: "+typeof h;}function t(r,h){x("data",r,"object");x("callback",h,"function");y(this);this.url||(this.url=this.restNamespace+"/"+this.restMethod+".json");var f=void 0==o.useSecure?!0:o.useSecure;o.debug&&Ti.API.info('ACS Request: { url: "'+this.url+'", verb: "'+this.verb+'", secure: '+(f?"YES":"NO")+", data: "+JSON.stringify(r)+
" })");w.send(this.url,this.verb,r,f,function(g){if(h){var f=g.response;f||(f={});g.meta&&"ok"==g.meta.status?(f.success=!0,f.error=!1,f.meta=g.meta,o.debug&&Ti.API.info(JSON.stringify(f))):(f.success=!1,f.error=!0,f.code=g.meta?g.meta.code:g.statusCode,f.message=g.meta?g.meta.message:g.message||g.statusText,o.debug&&Ti.API.error(f.code+": "+f.message));h(f)}})}function j(){t.call(this,2==arguments.length?arguments[0]:{},2==arguments.length?arguments[1]:arguments[0])}function z(r){t.call(this,{},
r)}function y(r){r.restNamespace||(r.restNamespace=r.property.toLowerCase());r.restMethod||(r.restMethod=r.method.toLowerCase())}var p={PROPERTY_TYPE_ONLY_LATEST:0,PROPERTY_TYPE_SLASH_COMBINE:1,PROPERTY_TYPE_IGNORE:2};p.build=function h(f,g){var o=g.children||[],j;for(j in o)if(o.hasOwnProperty(j)){var l=o[j],e=l.propertyTypes||g.propertyTypes||{};e.children=p.PROPERTY_TYPE_IGNORE;for(var q in g)if(g.hasOwnProperty(q))switch(e[q]||p.PROPERTY_TYPE_ONLY_LATEST){case p.PROPERTY_TYPE_ONLY_LATEST:l[q]=
void 0===l[q]?g[q]:l[q];break;case p.PROPERTY_TYPE_SLASH_COMBINE:var u=[];g[q]&&u.push(g[q]);l[q]&&u.push(l[q]);l[q]=u.join("/")}l.method&&!l.children?f[l.method]=function(e){return function(){return e.executor.apply(e,arguments)}}(l):l.property&&h(f[l.property]={},l)}};p.build(o,{verb:"GET",executor:t,children:[{method:"hasStoredSession",executor:function(){return w.hasStoredSession()}},{method:"retrieveStoredSession",executor:function(){return w.retrieveStoredSession()}},{property:"Chats",children:[{method:"create",
verb:"POST"},{method:"query"},{method:"getChatGroups",restMethod:"get_chat_groups",executor:j}]},{property:"Checkins",children:[{method:"create",verb:"POST"},{method:"query",executor:j},{method:"show"},{method:"remove",restMethod:"delete",verb:"DELETE"}]},{property:"Clients",children:[{method:"geolocate",executor:j}]},{property:"Objects",executor:function(h,f){var g;h&&"object"==typeof h&&(x("data.classname",h.classname,"string"),y(this),this.url=this.restNamespace+"/"+h.classname+"/"+this.restMethod+
".json",g=h.classname,delete h.classname);t.call(this,h,f);h.classname=g},children:[{method:"create",verb:"POST"},{method:"show"},{method:"update",verb:"PUT"},{method:"remove",restMethod:"delete",verb:"DELETE"},{method:"query"}]},{property:"Emails",restNamespace:"custom_mailer",children:[{method:"send",verb:"POST",restMethod:"email_from_template"}]},{property:"KeyValues",children:[{method:"set",verb:"PUT"},{method:"get"},{method:"append",verb:"PUT"},{method:"increment",restMethod:"incrby",verb:"PUT"},
{method:"remove",restMethod:"delete",verb:"DELETE"}]},{property:"Photos",children:[{method:"create",verb:"POST"},{method:"show"},{method:"search"},{method:"query",executor:j},{method:"update",verb:"PUT"},{method:"remove",restMethod:"delete",verb:"DELETE"}]},{property:"PhotoCollections",restNamespace:"collections",children:[{method:"create",verb:"POST"},{method:"show"},{method:"update",verb:"PUT"},{method:"search"},{method:"showSubcollections",restMethod:"show/subcollections"},{method:"showPhotos",
restMethod:"show/photos"},{method:"remove",restMethod:"delete",verb:"DELETE"}]},{property:"Places",children:[{method:"create",verb:"POST"},{method:"search",executor:j},{method:"show"},{method:"update",verb:"PUT"},{method:"remove",restMethod:"delete",verb:"DELETE"},{method:"query",executor:j}]},{property:"Posts",children:[{method:"create",verb:"POST"},{method:"show"},{method:"query",executor:j},{method:"update",verb:"PUT"},{method:"remove",restMethod:"delete",verb:"DELETE"}]},{property:"PushNotifications",
...
verb:"POST"},{method:"externalAccountUnlink",restMethod:"external_account_unlink",verb:"DELETE"},{method:"searchFacebookFriends",restNamespace:"social",restMethod:"facebook/search_friends",executor:z}]},{property:"Statuses",children:[{method:"create",verb:"POST"},{method:"search"},{method:"query",executor:j}]},{property:"Users",children:[{method:"create",verb:"POST"},{method:"login",verb:"POST"},{method:"show"},{method:"showMe",restMethod:"show/me",executor:z},{method:"search",executor:j},{method:"query",
executor:j},{method:"update",verb:"PUT"},{method:"logout",executor:function(h){t.call(this,{},function(f){w.reset();h(f)})}},{method:"remove",restMethod:"delete",verb:"DELETE",executor:function(){var h=arguments;t.call(this,2==h.length?h[0]:{},function(f){w.reset();(2==h.length?h[1]:h[0])(f)})}},{method:"requestResetPassword",restMethod:"request_reset_password"}]}]});var w=function(){function h(a,d){a[d>>5]|=128<<24-d%32;a[(d+64>>9<<4)+15]=d;for(var b=Array(80),v=1732584193,e=-271733879,c=-1732584194,
i=271733878,h=-1009589776,k=0;k<a.length;k+=16){for(var g=v,l=e,j=c,o=i,q=h,n=0;80>n;n++){b[n]=16>n?a[k+n]:(b[n-3]^b[n-8]^b[n-14]^b[n-16])<<1|(b[n-3]^b[n-8]^b[n-14]^b[n-16])>>>31;var p=v<<5|v>>>27,t;t=20>n?e&c|~e&i:40>n?e^c^i:60>n?e&c|e&i|c&i:e^c^i;p=f(f(p,t),f(f(h,b[n]),20>n?1518500249:40>n?1859775393:60>n?-1894007588:-899497514));h=i;i=c;c=e<<30|e>>>2;e=v;v=p}v=f(v,g);e=f(e,l);c=f(c,j);i=f(i,o);h=f(h,q)}return[v,e,c,i,h]}function f(a,d){var b=(a&65535)+(d&65535);return(a>>16)+(d>>16)+(b>>16)<<16|
b&65535}function g(a){for(var d=[],b=(1<<u)-1,e=0;e<a.length*u;e+=u)d[e>>5]|=(a.charCodeAt(e/u)&b)<<32-u-e%32;return d}function j(a,d,b){d?(this.oauthKey=a,this.oauthSecret=d):this.appKey=a;this.apiBaseURL=b?b:c.acs.sdk.url.baseURL;return this}function t(a,d){var b,e="production"==Ti.App.deployType.toLowerCase()?"production":"development";return(b=Ti.App.Properties.getString(a+"-"+e))&&"undefined"!=b||(b=Ti.App.Properties.getString(a))&&"undefined"!=b?b:d}var l={},e;null==e&&(e={});e.setProperties=
...
d[b];"oauth_signature"!=c[0]&&a.push([e.percentEncode(c[0])+" "+e.percentEncode(c[1]),c])}a.sort(function(a,b){return a[0]<b[0]?-1:a[0]>b[0]?1:0});d=[];for(b=0;b<a.length;++b)d.push(a[b][1]);return e.formEncode(d)}});e.SignatureMethod.registerMethodClass(["PLAINTEXT","PLAINTEXT-Accessor"],e.SignatureMethod.makeSubclass(function(){return this.key}));e.SignatureMethod.registerMethodClass(["HMAC-SHA1","HMAC-SHA1-Accessor"],e.SignatureMethod.makeSubclass(function(a){q="=";var d=this.key,b=g(d);16<b.length&&
(b=h(b,d.length*u));for(var c=Array(16),d=Array(16),e=0;16>e;e++)c[e]=b[e]^909522486,d[e]=b[e]^1549556828;a=h(c.concat(g(a)),512+a.length*u);a=h(d.concat(a),672);b="";for(d=0;d<4*a.length;d+=3){c=(a[d>>2]>>8*(3-d%4)&255)<<16|(a[d+1>>2]>>8*(3-(d+1)%4)&255)<<8|a[d+2>>2]>>8*(3-(d+2)%4)&255;for(e=0;4>e;e++)b=8*d+6*e>32*a.length?b+q:b+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(c>>6*(3-e)&63)}return b}));var q="",u=8;j.prototype.sendRequest=function(a,d,b,f,h){var s=c.acs.js.sdk.utils.getAuthType(this);
if(s==c.acs.constants.unknown)h(c.acs.constants.noAppKeyError);else{var i="",i=f?i+c.acs.sdk.url.https:i+c.acs.sdk.url.http,i=i+(this.apiBaseURL+"/"+c.acs.sdk.url.version+"/"+a);s==c.acs.constants.app_key&&(i+=c.acs.constants.keyParam+this.appKey);b||(b={});d=d?d.toUpperCase():c.acs.constants.get_method;f=b;if(Ti.App.analytics){var g=f.analytics||{};g.id=Ti.Platform.createUUID();Ti.Platform.id&&(g.mid=Ti.Platform.id);g.aguid=Ti.App.guid;g.event="cloud."+a.replace(/\//g,".").replace(/\.json/,"");g.deploytype=
Ti.App.deployType||"development";g.sid=Ti.App.sessionId;f.ti_analytics=JSON.stringify(g)}b=c.acs.js.sdk.utils.cleanInvalidData(b);if(a=c.acs.js.sdk.utils.getFileObject(b)){try{var k;k=a.toString().match(/TiFilesystemFile/)?a.read():a;if(!k){h(c.acs.constants.fileLoadError);return}b[c.acs.constants.file]?(delete b[c.acs.constants.file],b[c.acs.constants.file]=k):b[c.acs.constants.photo]&&(delete b[c.acs.constants.photo],b[c.acs.constants.photo]=k)}catch(l){h(c.acs.constants.fileLoadError);return}k=
{};s==c.acs.constants.oauth&&(s={method:d,action:i,parameters:[]},c.acs.js.sdk.utils.populateOAuthParameters(s.parameters,this.oauthKey),e.completeRequest(s,{consumerSecret:this.oauthSecret}),"mobileweb"==Ti.Platform.osname?i+="?"+c.acs.js.sdk.utils.getOAuthParameters(s.parameters):k.Authorization=e.getAuthorizationHeader("",s.parameters))}else if(k={},s==c.acs.constants.oauth){var s={method:d,action:i,parameters:[]},j;for(j in b)b.hasOwnProperty(j)&&s.parameters.push([j,b[j]]);c.acs.js.sdk.utils.populateOAuthParameters(s.parameters,
this.oauthKey);e.completeRequest(s,{consumerSecret:this.oauthSecret});"mobileweb"==Ti.Platform.osname?i+="?"+c.acs.js.sdk.utils.getOAuthParameters(s.parameters):k.Authorization=e.getAuthorizationHeader("",s.parameters)}c.acs.js.sdk.utils.sendAppceleratorRequest(i,d,b,k,h)}};var c;c||(c={});c.acs||(c.acs={});c.acs.constants||(c.acs.constants={});c.acs.js||(c.acs.js={});c.acs.js.sdk||(c.acs.js.sdk={});c.acs.js.sdk.utils||(c.acs.js.sdk.utils={});c.acs.sdk||(c.acs.sdk={});c.acs.sdk.url||(c.acs.sdk.url=
...
d.length&&(d=d.substring(1));return d};c.acs.js.sdk.utils.populateOAuthParameters=function(a,d){a&&d&&(a.push(["oauth_version","1.0"]),a.push(["oauth_consumer_key",d]),a.push(["oauth_signature_method","HMAC-SHA1"]),a.push(["oauth_nonce",e.nonce(15)]))};c.acs.js.sdk.utils.sendAppceleratorRequest=function(a,d,b,f,h){var g=Ti.Network.createHTTPClient({timeout:6E4,onsendstream:function(b){o.onsendstream&&o.onsendstream({url:a,progress:b.progress})},ondatastream:function(b){o.ondatastream&&o.ondatastream({url:a,
progress:b.progress})},onerror:function(a){var b={},d=this.responseText;try{var c=d;if(!c||0>=c.length)d=!1;else{for(var c=c.replace(/^\s\s*/,""),e=/\s/,f=c.length;e.test(c.charAt(--f)););d=c.slice(0,f+1)}d&&0<d.length&&(b=JSON.parse(d))}catch(g){b=g}b.message||(b.message=a.error);b.error=!0;b.statusText=this.statusText;b.status=this.status;b.meta&&(b.metaString=JSON.stringify(b.meta));h(b)},onload:function(){var a=JSON.parse(this.responseText);a&&a.meta&&(a.metaString=JSON.stringify(a.meta),c.acs.js.sdk.utils.storeSessionId(a.meta.session_id));
h(a)}}),i=a;switch(d.toUpperCase()){case "DELETE":case "GET":var j="",k;for(k in b)b.hasOwnProperty(k)&&(j+="&"+k+"="+e.percentEncode(b[k]));0<j.length&&(i=0<a.indexOf("?")?i+j:i+("?"+j.substring(1)),b={})}o.debug&&(Ti.API.info(d+": "+i),Ti.API.info("header: "+JSON.stringify(f)),Ti.API.info("data: "+JSON.stringify(b)));"mobileweb"==Ti.Platform.osname?(g._xhr.open(g.constants.connectionType=d,g.constants.location=i,!1),g._xhr.withCredentials="true"):g.open(d,i);g.setRequestHeader("Accept-Encoding",
"gzip,deflate");if(f)for(k in f)f.hasOwnProperty(k)&&g.setRequestHeader(k,f[k]);(d=c.acs.js.sdk.utils.retrieveSessionId())&&g.setRequestHeader("Cookie","_session_id="+d);g.send(b)};var p=null;l.send=function(a,d,b,c,e){if(null==p){var f=t("acs-api-key",null),g=t("acs-base-url","api.cloud.appcelerator.com"),h=t("acs-oauth-key",null),k=t("acs-oauth-secret",null);if(h&&k)p=new j(h,k,g);else if(f)p=new j(f,null,g);else throw"ACS CREDENTIALS NOT SPECIFIED!";}p.sendRequest(a,d,b,c,e)};l.hasStoredSession=
function(){return!!c.acs.js.sdk.utils.retrieveSessionId()};l.retrieveStoredSession=function(){return c.acs.js.sdk.utils.retrieveSessionId()};l.reset=function(){c.acs.js.sdk.utils.clearSessionId();p=null};return l}();return o};
});
}});
require("Ti/App/Properties", function(p) {
p.setString("acs-api-key-production","Fgg3h53Zw1vzFlC6Bu703jyvS7ctMj2c");
p.setString("acs-api-key-development","jvnFGkayWrzHMaJdz1HETgQ8fh9E8dF8");
p.setString("acs-oauth-secret-development","BbVi1nwMQfDxiuFoJpZGfVHPlMIjH5Xr");
p.setString("ti.map.apikey","");
p.setString("ti.ui.defaultunit","system");
p.setString("acs-oauth-secret-production","mfpKS7sp6AxZw2NEadHnqY4CaRudMLr7");
p.setString("acs-oauth-key-development","0CwYu23xxazTzddfTGbRXWxt8Uw6J3Yi");
p.setString("ti.map.backend","Ti/_/Map/Google");
p.setString("ti.fs.backend","Ti/_/Filesystem/Local");
p.setString("acs-oauth-key-production","D6szJfAvTzwUcPAJCdL6BkmUAHzBWG49");
});
